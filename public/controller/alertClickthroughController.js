...
//    alert clickthrough button svgs
    ...
    $scope.ALERTSVG = '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 100 125" style="enable-background:new 0 0 100 100;" xml:space="preserve"><g><path d="M76.7,81.6h-7.3V63.5c0-10.7-8.7-19.4-19.4-19.4s-19.4,8.7-19.4,19.4v18.1h-7.3c-1.5,0-2.7,1.2-2.7,2.7s1.2,2.7,2.7,2.7   h53.4c1.5,0,2.7-1.2,2.7-2.7S78.2,81.6,76.7,81.6z M36,63.5c0-7.7,6.3-14,14-14s14,6.3,14,14v18.1H36V63.5z"/><path d="M50,36.3c1.5,0,2.7-1.2,2.7-2.7v-18c0-1.5-1.2-2.7-2.7-2.7s-2.7,1.2-2.7,2.7v18C47.3,35.2,48.5,36.3,50,36.3z"/><path d="M31,41.3c0.5,0.5,1.2,0.8,1.9,0.8s1.4-0.3,1.9-0.8c1-1,1-2.7,0-3.8L22.5,25.3c-1-1-2.7-1-3.8,0s-1,2.7,0,3.8L31,41.3z"/><path d="M66.9,43c0.5,0.4,1.1,0.6,1.7,0.6c0.8,0,1.6-0.3,2.1-1l10.9-13.7c0.9-1.2,0.7-2.8-0.4-3.7c-1.2-0.9-2.8-0.7-3.7,0.4   L66.4,39.2C65.5,40.4,65.7,42,66.9,43z"/><path d="M24.1,56.6c0-1.5-1.2-2.7-2.7-2.7h-14c-1.5,0-2.7,1.2-2.7,2.7s1.2,2.7,2.7,2.7h14C23,59.2,24.1,58,24.1,56.6z"/><path d="M92.5,53.9h-14c-1.5,0-2.7,1.2-2.7,2.7s1.2,2.7,2.7,2.7h14c1.5,0,2.7-1.2,2.7-2.7S94,53.9,92.5,53.9z"/></g></svg>'
...
//    alert clicktrough buttons 
    var buttons = {
        ...
        alert: {
            svg: $sce.trustAsHtml($scope.ALERTSVG),
            text: $scope.LANG.SENDALERT,
            id: "alert",
            next: true
        },
        injury: {
...
//    alert clickthrough views
    this.views = [
        ...
        },
        {
            previous: 0,
            next: 2,
            title: $scope.LANG.ALERTLOCATION,
            buttons: [
                buttons.floorplan,
                buttons.custom,
                buttons.back
